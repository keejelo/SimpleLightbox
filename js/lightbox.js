...
// ** Modified by me to be more responsive/flexible and easier to use and implement.
//
...
let SimpleLightbox = (function()
{
    ...
    function createModal()
    {
        ...
        if(lightboxSet)
        {
            ...
            if(lightboxThumbs[0] && lightboxSlides && lightboxModalThumbs)
            {
                ...
                {
                    //let slideNum = lightboxThumbs[i].getElementsByTagName('a')[0].getAttribute('rel');
                    //let slideSrc = lightboxThumbs[i].getElementsByTagName('a')[0].getAttribute('href');
                    //let slideTitle = lightboxThumbs[i].getElementsByTagName('a')[0].getAttribute('title');
    ...
    function onResize()
    {
        ...
        {
            //let modalPaddingTop = parseInt(window.getComputedStyle(modal[0], null).getPropertyValue('padding-top'));
    ...
    window.addEventListener('load', function(e)
    {
        ...
        if(thumbs[0])
        {
            for(let i = 0; i < thumbs.length; i++)
            {
                ...
                {
                    openModal();
                    //currentSlide(thumbs[i].getElementsByTagName('a')[0].getAttribute('rel'));
